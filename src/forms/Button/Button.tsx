...
const Button = ({ className, icon, ...props }: IButton) => (
	<Button_
		...
		type="primary"
		className={twMerge(
			"bg-blue-500 hover:!bg-blue-500/80 disabled:!bg-primary outline-none border-none disabled:bg-disabled shadow-none text-[20px] md:text-[18px] px-[40px] py-[10px] md:py-[15px] h-max font-semibold active:bg-blue-500/80 *:text-white rounded-[36px] md:rounded-[60px]",
